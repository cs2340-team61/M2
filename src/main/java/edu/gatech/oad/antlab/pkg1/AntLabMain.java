 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Brent Bessemer");
		  toPrint += p1.toString("bbessemer3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Lewis Vaughan");
		  toPrint += p2.toString("lvaughan9");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Sahej Gill");
		  toPrint += p3.toString("sgill12");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Neil");
                  toPrint += p4.toString("npatel434");
